...
void BookingFromDelhiToGurugram();//Function Prototype
void BookingFromGhaziabadToNoida();//Function Prototype
void BookingFromGreaterNoidaToIGIAirport();//Function Prototype
void BookingFromDLFMallOfIndiaToRDC();//Function Prototype
 const int Size=10;
...
//*********************************************************************************************************
    ...
    switch(choice)
 {
       ...
       system("CLS");
               ...
               cout<<endl;
               cout<<endl;
               cout<<"<1> To Book Cab From Delhi To Gurugram"<<endl;
               cout<<endl;
               cout<<"<2> To Book Cab From Ghaziabad To Noida"<<endl;
               cout<<endl;
               cout<<"<3> To Book Cab From Greater Noida To IGI Airport"<<endl;
               cout<<endl;
               cout<<"<4> To Book Cab From DLF Mall Of India To RDC"<<endl;
               cout<<endl;
                  ...
                  switch(choice)
               {
                        ...
                        case 1:
                             {count++;
                                   BookingFromDelhiToGurugram();//Calling function
                 break;
                             }
                        case 2:
                             {
                                    BookingFromGhaziabadToNoida();//Calling function
            break;
                             }
                        case 3:
                             {
                                    BookingFromGreaterNoidaToIGIAirport();//Calling function           
                                    break;
                             }
                        case 4:
       {   
         BookingFromDLFMallOfIndiaToRDC();//Calling function 
         break;
                            }
                       case 5:
                            {
...
void BookingFromDelhiToGurugram()
{
 ...
 else if(PaidCharges =='y')
 {
   ...
   MyFile <<"\nPick : Delhi";//writing on file
   MyFile <<"\nDrop:Gurugram";//writing on file
 ...
 else
 {
  ...
  MYFile <<"\n\t\tBooking Caceled\n";//writing on file
  MYFile << "\nNAme : "<< Name;//writing on file
  MYFile <<"\nPick : Ghaziabad";//writing on file
  MYFile <<"\nDrop:Noida";//writing on file
  MYFile <<"\nDistance: 18Km";//writing on file
  MYFile <<"\nCharges: Rs"<< Charges;//writing on file
  MYFile.close();//File Close
  count--;
 }
...
void BookingFromGhaziabadToNoida()
{
 if(CABSTATUS[1]==0 && CABSTATUS[2]==0 && CABSTATUS[3]==0 && CABSTATUS[4]==0 && CABSTATUS[5]==0 )
  {
   cout<<"All The cabs Are Book"<<endl;
...
void BookingFromGreaterNoidaToIGIAirport()
{
 ...
 if(PaidCharges =='Y')
 {
   ...
   MyFile <<"\n\t\tCustomer Record\n";//writing on file
   MyFile << "\nNAme : "<< Name;//writing on file
   MyFile <<"\nPick : Greater Noida";//writing on file
   MyFile <<"\nDrop:IGI Airport";//writing on file
   MyFile <<"\nDistance: 48Km";//writing on file
   MyFile <<"\nCharges: Rs"<< Charges;//writing on file
   MyFile.close();//File Close
   CABSTATUS[count]=0;
   Sleep(1000);
...
void BookingFromDLFMallOfIndiaToRDC()
{
 if(CABSTATUS[1]==0 && CABSTATUS[2]==0 && CABSTATUS[3]==0 && CABSTATUS[4]==0 && CABSTATUS[5]==0 )
  {
   cout<<"All The cabs Are Book"<<endl;
 ...
 if(PaidCharges =='Y')
 {
   ...
   MyFile <<"\n\t\tCustomer Record\n";//writing on file
   MyFile << "\nNAme : "<< Name;//writing on file
   MyFile <<"\nPick : DLF Mall Of India";//writing on file
   MyFile <<"\nDrop:RDC";//writing on file
   MyFile <<"\nDistance: 26Km";//writing on file
   MyFile <<"\nCharges: Rs"<< Charges;//writing on file
   MyFile.close();//File Close
   CABSTATUS[count]=0;
   Sleep(1000);
